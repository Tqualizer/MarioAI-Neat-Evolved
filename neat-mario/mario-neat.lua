...
while true do
	...
	if timeout + timeoutBonus <= 0 then
        ...
        local fitness = rightmost*1.4 + coinScoreFitness - pool.currentFrame/3 - hitPenalty*5
	...
	forms.settext(MaxLabel, "TopFit: " .. math.floor(pool.maxFitness))
